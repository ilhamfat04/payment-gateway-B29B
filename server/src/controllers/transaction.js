...
exports.addTransaction = async (req, res) => {
  try {
    // Prepare transaction data from body here (step 1)...
    let data = req.body;
    data = {
    ...
    // Insert transaction data here (step 1)...
    const newData = await transaction.create(data);

    // Get buyer data here (step 2 persiapan)...
    ...
    // Create Snap API instance here (step 2 persiapan)...
    ...
    // Create parameter for Snap API here (step 2 persiapan) ...
    let parameter = {
      transaction_details: {
        order_id: newData.id,
    ...
    // Create trasaction token & redirect_url with snap variable here (step 2)...
...
// Create function for handle transaction update status here (persipaan step 4)...
...
// Create function for handle product update stock/qty here (persiapan step 4)...
